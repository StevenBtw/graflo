...
8. **[Explicit `connector_connection` Proxy Wiring](example-9.md)** - Show how manifest proxy labels (`conn_proxy`) are resolved at runtime into real DB configs via `ConnectionProvider`.